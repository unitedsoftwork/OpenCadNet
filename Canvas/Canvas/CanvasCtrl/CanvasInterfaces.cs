...
namespace Canvas
{
	...
	public interface ICanvas
	{
		...
		void DrawSolid(ICanvas canvas, Pen pen, UnitPoint p1, UnitPoint p2, UnitPoint p3, UnitPoint p4);
        void DrawText(ICanvas canvas, Pen pen, UnitPoint position,string value, Font font,float rotation);
        void DrawMultilineText(ICanvas canvas, Pen pen, UnitPoint position, string text, Font font, float rotation);
	...
	public interface IModel
	{
		...
		List<IDrawObject> GetHitObjects(ICanvas canvas, List<PointF> selection, bool anyPoint);
	...
	public interface IDrawObject
	{
        ...
        bool ObjectInShape(ICanvas canvas, List<PointF> shape, bool anyPoint);
